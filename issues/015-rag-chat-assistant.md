...
- [ ] **B. Retrieval core** (AFK, TDD) — pure cosine-similarity top-k over the embeddings manifest, **ported to JS** for the Worker. *Test: `tests/chat-retrieve.test.js` — ranking on a fixed fixture, offline. Blocked by: A2.*
