...
| [002](issues/002-pages-cms-connected.md) | Pages CMS connected; admin can CRUD events | HITL | Schema done; CMS connect HITL | 001 |
...
| [012](issues/012-blog-rendering.md) | Blog rendering: home section + list page + detail page | AFK | Open | 011 |
| [013](issues/013-photo-gallery.md) | Photo gallery: home strip + gallery page + lightbox | AFK | Open | 011 |
